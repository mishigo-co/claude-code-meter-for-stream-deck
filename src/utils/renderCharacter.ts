...
function eyesNormal(a: Anchors, dy: number, p: Palette): string {
	return (
		r(a.eyeLeftX, dy + a.eyesY, 2, 2, p.white) +
		r(a.eyeLeftX, dy + a.eyesY, 1, 1, p.pupil) +
		r(a.eyeRightX, dy + a.eyesY, 2, 2, p.white) +
		r(a.eyeRightX + 1, dy + a.eyesY, 1, 1, p.pupil)
	);
}
...
function eyesUp(a: Anchors, dy: number, p: Palette): string {
	return (
		r(a.eyeLeftX, dy + a.eyesY - 1, 2, 2, p.white) +
		r(a.eyeLeftX + 1, dy + a.eyesY - 1, 1, 1, p.pupil) +
		r(a.eyeRightX, dy + a.eyesY - 1, 2, 2, p.white) +
		r(a.eyeRightX, dy + a.eyesY - 1, 1, 1, p.pupil)
	);
}
...
function eyesWide(a: Anchors, dy: number, p: Palette): string {
	return (
		r(a.eyeLeftX, dy + a.eyesY, 2, 2, p.white) +
		r(a.eyeLeftX, dy + a.eyesY + 1, 1, 1, p.pupil) +
		r(a.eyeRightX, dy + a.eyesY, 2, 2, p.white) +
		r(a.eyeRightX + 1, dy + a.eyesY + 1, 1, 1, p.pupil) +
		r(a.eyeLeftX - 1, dy + a.eyesY - 1, 1, 1, p.hilit) +
		r(a.eyeRightX + 2, dy + a.eyesY - 1, 1, 1, p.hilit)
	);
}
...
function mouthSmile(a: Anchors, dy: number, p: Palette): string {
	return (
		...
		r(a.mouthX - 1, dy + a.mouthY - 1, 1, 1, p.shade) +
		r(a.mouthX + 4, dy + a.mouthY - 1, 1, 1, p.shade)
	);
}
