 ...
 */
export function renderGrid(base: string[], pal: Palette, dyPx: number, gridSize: number = GRID): string {
...
export type ValidationResult = { ok: true; pack: CharacterPack } | { ok: false; error: string };
